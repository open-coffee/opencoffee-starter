 ...
 * @since  0.15.0
 */
public class CoffeeNetWebServiceWithDiscoveryAndSecurity implements CoffeeNetWebService {
    ...
    CoffeeNetWebServiceWithDiscoveryAndSecurity(CoffeeNetCurrentUserService coffeeNetCurrentUserService,
